...
func compactToolDescription(name, fallback string) string {
	descriptions := map[string]string{
		...
		"read_file":             "Read a file with line numbers. Do not use without a range for .md files; use Markdown tools or ranges.",
		...
		"edit_file":             "Replace a specific 1-indexed line range in a file.",
